...
from models.mo_ori_lstm_noco import PC_MO_LSTM_NOC
...
class MO_LSTM_BD(pl.LightningModule):
    def __init__(self, train_config):
        super(MO_LSTM_BD, self).__init__()
        self.model = PC_MO_LSTM_NOC()
...
def train_model():
    ...
    pc_fc_model = MO_LSTM_BD.load_from_checkpoint(checkpoint_path='checkpoints/mo_lstm_bd_noc/best-checkpoint-epoch=15-val_loss=0.90.ckpt', train_config=train_config)

    checkpoint_callback = ModelCheckpoint(
        monitor='val_loss',
        dirpath='checkpoints/mo_lstm_bd_noc/',
    ...
    seq_logger = TensorBoardLogger("logs", name="molstm_bd_noc_CKPT")
