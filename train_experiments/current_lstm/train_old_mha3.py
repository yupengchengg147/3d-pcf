...
from models.old_mha_3 import MHA_l3
...
class MO_MHA_3(pl.LightningModule):
    def __init__(self, train_config):
        super(MO_MHA_3, self).__init__()
        self.model = MHA_l3()
...
def train_model():
    ...
    pc_fc_model = MO_MHA_3(train_config)
    ...
    seq_logger = TensorBoardLogger("logs", name="mha_3")
