...
from models.global_v2 import PCF_GLOBAL_not
...
class GL_not(pl.LightningModule):
    def __init__(self, train_config):
        super(GL_not, self).__init__()
        self.model = PCF_GLOBAL_not()
...
def train_model():
    ...
    pc_fc_model = GL_not(train_config)
    ...
    seq_logger = TensorBoardLogger("logs", name="gl_not")
