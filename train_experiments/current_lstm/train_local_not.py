...
from models.local_not import PC_MO_NOT
...
class MO_Local_Not(pl.LightningModule):
    def __init__(self, train_config):
        super(MO_Local_Not, self).__init__()
        self.model = PC_MO_NOT()
...
def train_model():
    ...
    train_config = {'lr': 1e-3, 'batch_size':2, 'num_pred': 5, 'beta': (0.9, 0.999), 'num_points': 16384*2}
    data_config = {'root': "/usr/stud/ype/storage/user/kittidata/dataset/sequences", 'npoints': 16384*2, 'input_num': 5, 'pred_num': 5, 'tr_seqs': ['00', '01','02','03','04','05'],'val_seqs': ['08','09','10']}
    ...
    pc_fc_model = MO_Local_Not(train_config)
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor='val_loss',
        dirpath='checkpoints/local_not_2/',
    ...
    seq_logger = TensorBoardLogger("logs", name="local_not_2")
