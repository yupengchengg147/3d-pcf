...
from models.mo_lstm_content_t2 import PC_MO_LSTM_TDE2
...
class MO_LSTM_TDE2(pl.LightningModule):
    def __init__(self, train_config):
        super(MO_LSTM_TDE2, self).__init__()
        self.model = PC_MO_LSTM_TDE2()
...
def train_model():
    ...
    train_config = {'lr': 1e-3, 'batch_size':8, 'num_pred': 5, 'beta': (0.9, 0.999), 'num_points': 16384}
    ...
    pc_fc_model = MO_LSTM_TDE2(train_config)

    checkpoint_callback = ModelCheckpoint(
        monitor='val_loss',
        dirpath='checkpoints/abst2/',
    ...
    seq_logger = TensorBoardLogger("logs", name="abst2")
