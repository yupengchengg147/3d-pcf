...
from models.mo_ori_lstm import PC_MO_LSTM
...
def train_model():
    ...
    train_config = {'lr': 1e-4, 'batch_size':6, 'num_pred': 5, 'beta': (0.9, 0.999), 'num_points': 16384}
    ...
    # pc_fc_model = MO_LSTM_BD(train_config)
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor='val_loss',
        dirpath='checkpoints/mo_lstm_bd_1/',
    ...
    seq_logger = TensorBoardLogger("logs", name="molstm_bd_0029")
