...
from models.local_not_refine import PC_MO_NOT_R
...
class MO_Local_Not_R(pl.LightningModule):
    def __init__(self, train_config):
        super(MO_Local_Not_R, self).__init__()
        self.model = PC_MO_NOT_R()
...
def train_model():
    ...
    pc_fc_model = MO_Local_Not_R(train_config)
    ...
    seq_logger = TensorBoardLogger("logs", name="refine")
