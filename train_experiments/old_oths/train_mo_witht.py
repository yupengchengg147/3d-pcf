...
class MO_not(pl.LightningModule):
    def __init__(self, att_args, train_config):
        ...
        self.model = PC_MO_KNN_witht(att_args)
...
def train_model():
    ...
    train_config = {'lr': 1e-3, 'batch_size':1, 'num_pred': 5, 'beta': (0.9, 0.999), 'num_points': 8192}

    data_config = {'root': "/home/stud/ding/PC_FC/PC_forecasting/kittiraw/dataset/sequences", 'npoints': 8192, 'input_num': 5, 'pred_num': 5, 'tr_seqs': ['00', '01','02','03','04','05','06','07'],'val_seqs': ['08','09','10']}
    ...
    seq_logger = TensorBoardLogger("logs", name="model_8192_1150")
